...
if ( # any(hi_ha_canvis) &&
  ...
  message("GITHUB_EVENT_NAME: ", Sys.getenv("GITHUB_EVENT_NAME"))
  message("GITHUB_WORKFLOW: ", Sys.getenv("GITHUB_WORKFLOW"))
  message("TME_OSMCAT_CHATID: ", Sys.getenv("TME_OSMCAT_CHATID"))
  print(paste("monitorOSM_bot buit:", Sys.getenv("R_TELEGRAM_BOT_monitorOSM_bot") == ""))
  print(paste("bot_token buit:", as.character(telegram.bot::bot_token("monitorOSM_bot") == "")))
