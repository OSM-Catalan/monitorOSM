...
| [comarques](https://github.com/OSM-Catalan/monitorOSM/blob/main/data-raw/comarques.tsv) | 96 | 11 | name:ca , regio , osm_id , osm_type , name , wikipedia , wikidata , border_type , admin_level , historic:admin_level, ref:idescat |
| [municipis](https://github.com/OSM-Catalan/monitorOSM/blob/main/data-raw/municipis.tsv) | 1699 | 13 | name:ca , regio , comarca , osm_id , osm_type , name , wikipedia , wikidata , border_type, admin_level, ref:idescat, ref:ine , ref:INSEE |
| [loc_admin_centre_municipis](https://github.com/OSM-Catalan/monitorOSM/blob/main/data-raw/loc_admin_centre_municipis.tsv) | 1700 | 15 | name:ca , regio , comarca , municipi , osm_type , osm_id , name , wikidata , wikipedia , place , capital , admin_level, ref:idescat, ref:ine , ref:INSEE |
| [loc_ref](https://github.com/OSM-Catalan/monitorOSM/blob/main/data-raw/loc_ref.tsv) | 4996 | 14 | name:ca , regio , comarca , municipi , osm_type , osm_id , name , wikidata , wikipedia , place , capital , admin_level, ref:idescat, ref:ine |

Topònims dels PPCC

| bd | n_obj | n_cols | columnes |
|:---|---:|---:|:---|
| [mars](https://github.com/OSM-Catalan/monitorOSM/blob/main/data-raw/mars.tsv) | 148 | 8 | name:ca , name , osm_id , osm_type , alt_name , alt_name:ca, place , wikidata |
...
En total es monitoritzen 9158 objectes d’OpenStreetMap.
...
comarques <- head(comarques, 3) # subconjunt d'exemple

cims_comarca <- mapply(function(id, nom, territori) {
  out <- opq(bbox = paste0("relation(id:", id, ")"), out = "tags", timeout = "1000") |>
    add_osm_feature(key = "natural", value = "peak") |>
    opq_csv(fields = c("name:ca", "::id", "::type", "name", "wikipedia", "wikidata")) |>
    osmdata_data_frame()
...
#> 6    <NA> Andorra Andorra la Vella 12359982620     node Roc de Salobre
#>   wikipedia  wikidata
#> 1      <NA> Q21329274
#> 2      <NA> Q21329357
#> 3      <NA>      <NA>
